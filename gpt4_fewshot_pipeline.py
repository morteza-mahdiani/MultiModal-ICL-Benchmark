...
Answer:"
    ...
    def predict(self, text_prompt, images=None):
        import io, base64
        processed_images = []
        ...
        message = {
            "role": "user",
            "content": [{"type": "text", "text": text_prompt}] + processed_images
        }
...
def run_evaluation(output_path=None, batch_size=1, fewshot_k=8):
    ...
    dataset = dataset.select(range(50))  # Limit to 5 test samples for debugging
    dataset = dataset.map(
        load_image,
